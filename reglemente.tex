...
\begin{reglemlista}
	...
	\begin{attlista}
		...
		\begin{itemize}
			...
			\item Årskursrepresentant, D1 (2)
			\item Årskursrepresentant, C1 (2)
			\item Årskursrepresentant, D2 (2)
			\item Årskursrepresentant, C2 (2)
			\item Årskursrepresentant, D3 (2)
			\item Årskursrepresentant, C3 (2)
...
Bilansvarig är ansvarig för
sektionens bil(ar) då sådan(a) finns.
...
ScalD ansvarar för sångboken och ser till att den är uppdaterad och studentikos.
