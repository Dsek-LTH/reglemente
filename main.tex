...
\begin{reglemlista}
	...
	\begin{attlista}
		\item hjälpa Informationsansvarig
...
\begin{reglemlista}
	...
	\begin{attlista}
		\item hjälpa Aktivitetsansvarig
...
%%% funktionar %%%
\funktionar{Karnevalsansvarig (vart fjärde år)}
Karnevalsansvarig har hand om sektionens deltagande i karnevalen.
...
Kårrepresentant är ansvarig för att sektionen hålls underrättad om de beslut som kåren
...
Köksmästaren är den person som har det övergripande ansvaret för Sexmästeriets matlagning under deras evenemang.
...
\begin{reglemlista}
	...
	\begin{attlista}
		...
		\item övervaka Datatekniksektionen inom TLTH och tillse att det verkar enligt gällande reglemente och stadgar
...
\O verpepparna agerar Nollningsutskottets högra händer genom att vara med i planering
