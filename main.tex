...
kommunikation mellan styrelsen och sektionen. Propagandamästaren leder även propagandamästeriet
...
%%% funktionar %%%
\funktionar{Ljud och ljus ansvarig}
  Ljud och ljus ansvarig är ansvarig för sektionens ljud- och
  ljusutrustning.

  \begin{reglemlista}

    \item[Åligganden]
      Det åligger Ljud och ljus ansvarig
      \begin{attlista}
...
\funktionar{Medrepresentant Utbildningsnämnd A}
  \begin{reglemlista}
    ...
    \item[Åligganden]
    Det åligger Medrepresent Utbildningsnämnd A
    \begin{attlista}
...
blivit vald till av TLTHs fullmäktige
        ...
        \item informera studierådet om kommande, samt vad som sagts på tidigare, HMSkommitémöten.
...
Datatekniksektionens årliga arbetsmarknadsmässa Teknikfokus
 ...
 \begin{reglemlista}
 	...
 	\item[Åligganden]
 		...
 		\begin{attlista}
 			\item tillsammans med Näringslivsansvarig ansvara för arrangemanget av Teknikfokus.
  ...
  \begin{reglemlista}
    ...
    \item[Åligganden]
      ...
      \begin{attlista}
        ...
        \item övervaka Ordenssällskapet Datatekniksektionen vid Lunds Tekniska Högskola och tillse att det verkar enligt gällande reglemente och stadgar
