...
\begin{reglemlista}
	...
	Beslutsuppföljningen är en lista som ägs av sektionsmötet.  Den utgörs
        av de sektionsmötesbeslut som ska följas upp.

	Varje punkt i beslutsuppföljningen ska innehålla
	\begin{itemize}
	\item vad beslutet avser,
	\item när beslutet togs (möte och datum),
	\item vem som är ansvarig för att följa upp beslutet,
	\item vilket möte som uppföljning av beslutet ska redovisas på.
	\end{itemize}

	Sektionsmötet avgör vilka beslut som ska följas upp och när ett beslut
        har följts upp.

	En motion eller proposition bör beskriva vem som är ansvarig för dess
	uppföljning och till vilket möte den ska följas upp till, vid bifall.
	Saknas en eller båda av dessa kan de beslutas om under mötet.

	Om ett beslut som ska följas upp till det pågående mötet inte har blivit
	det, kan möte för redovisning senareläggas.

	Hur beslutsuppföljningen ser ut innan ett möte ska finnas i mötets
	handlingar och hur den ser ut efter mötet ska stå i mötets protokoll.
